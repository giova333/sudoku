...
25. **The theme is a table of roles, not a palette handed round.** A component
...
26. **TextMeshPro is still not in use, and the font atlases are not committed.**
...
27. **The editor tooling is compile-checked too** (`tools/check-editor.sh`,
